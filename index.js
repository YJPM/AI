...
@keyframes gradient-pulse {
    ...
    100% { background-position: 0% 50%; }
            ...
            ` }, // Keeping the content brief for the example
        },
    };
...
// ===============================================
// AI Director Feature - Self-contained module
// ===============================================
(function () {
    'use-strict';
...
`.trim(),
        ...
        async init(parentQuery) {
            ...
            console.log(`${this.LOG_PREFIX} 初始化中...`);
            ...
            console.log(`${this.LOG_PREFIX} 初始化完成。`);
        },
    ...
    function waitForSillyTavern() {
        ...
        const interval = setInterval(() => {
            ...
            if (isReady) {
                ...
                // Manually bind 'init' and call it
                AIDirector.init = AIDirector.init.bind(AIDirector);
                AIDirector.init(window.parent.jQuery);
            } else if (++retries > maxRetries) {
                clearInterval(interval);
                console.error(`${AIDirector.LOG_PREFIX} 等待SillyTavern核心功能超时。`);
            }
        }, 200);
    }
